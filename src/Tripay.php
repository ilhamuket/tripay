...
class Tripay
{
    ...
    public const SANDBOX_URL = 'https://tripay.co.id';
    public const PRODUCTION_URL = 'https://tripay.co.id';
    ...
    public function getPaymentChannels(?string $code = null): PaymentChannelResponse
    {
        ...
        $response = $this->httpClient->get('/api/merchant/payment-channel', $params);
    ...
    public function calculateFee(int $amount, ?string $code = null): FeeCalculatorResponse
    {
        ...
        $response = $this->httpClient->get('/api/merchant/fee-calculator', $params);
    ...
    public function getTransactions(array $params = []): TransactionResponse
    {
        ...
        $response = $this->httpClient->get('/api/merchant/transactions', $filteredParams);
    ...
    public function createTransaction(TransactionData $data): CreateTransactionResponse
    {
        ...
        $response = $this->httpClient->post('/api/transaction/create', $payload);
    ...
    {
        $response = $this->httpClient->get('/api/transaction/detail', [
            'reference' => $reference,
        ]);
    ...
    {
        $response = $this->httpClient->get('/api/transaction/check-status', [
            'reference' => $reference,
        ]);
    ...
    public function getPaymentInstruction(
        ...
        $response = $this->httpClient->get('/api/payment/instruction', $params);
